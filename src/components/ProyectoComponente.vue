<script setup>
import proyecto1 from '/src/assets/buscaminas.png';
import proyecto2 from '/src/assets/proximamente.png';
...
.galeria {
    ...
    background: linear-gradient(-45deg, #6a1d68, #6a036e, #da6ed8, #e2b6d0);
